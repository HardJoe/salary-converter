  ...
  return (
    <div className="w-full max-w-2xl bg-white border border-outline-variant rounded-2xl shadow-level-1 p-lg md:p-xl">
      <div className="grid grid-cols-1 gap-lg">
        {/* Row 1: Salary input + frequency toggle */}
...
function CountryDropdown({ value, options, onChange }: CountryDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {isOpen && (
        <div className="absolute z-50 top-full mt-1 w-full bg-white border border-outline-variant rounded-lg shadow-level-2 max-h-64 overflow-y-auto">
          {options.map((country) => (
            <button
              key={country.code}
              type="button"
